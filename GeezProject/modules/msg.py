...
class Messages():
      HELP_MSG = [
        ".",
f"""
**Halo kontol Selamat datang kembali di {PROJECT_NAME}
...
☠️ Lu kalo mau pake bot ini join dulu @Ms_Aliansi terus lu izin dulu sama bos besar @SignatureOfTheHero ya. Jelek muka lu, sini gua ludahin...
